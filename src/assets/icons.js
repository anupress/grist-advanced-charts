...
export const ICONS = {
  ...
  dashboards: S('<rect x="3" y="6" width="13" height="13" rx="2"/><path d="M8 6V5a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-1"/><path d="M3 11h13M8 11v8"/>'),
  widget: S('<rect x="3" y="3" width="18" height="18" rx="2.5"/><path d="M3 8h18"/><rect x="7" y="11.5" width="10" height="6" rx="1.2"/><path d="M5.5 5.5h.01M8 5.5h.01"/>'),
