    ...
    tabs: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            id: 'np19i', type: 'invoice', span: 12,
            config: {
              title: 'Issue a receipt', documentTitle: 'Receipt', style: 'banded', table: 'Donations',
              numberColumn: null, clientColumn: 'Donor', dateColumn: 'Date', dueColumn: null,
              amountColumn: 'Received', statusColumn: 'Status', noteColumn: null,
              referenceColumn: null, referenceLabel: 'Reference', totalLabel: 'Received with thanks',
              clientTable: null, clientNameColumn: 'Name', clientAddressColumns: [],
              itemsTable: null, itemsLinkColumn: null, itemDescColumn: null, itemQtyColumn: null,
              itemPriceColumn: null, itemTotalColumn: null, singleLineLabel: 'Charitable donation',
              from: { name: 'Anupress Community', address: '18 Riverside Way\nBristol BS1 6TH',
                email: 'hello@example.com', phone: '+1 (212) 555-0100', taxId: '', logoData: null },
              terms: 'No goods or services were provided in exchange for this contribution.',
              paymentDetails: '', paymentDetailsLabel: 'Payment details', preparedBy: '',
              thanksText: 'Thank you. Your gift funds the programmes listed on this site.',
              currency: '$', taxRate: 0, taxLabel: 'Tax', taxIdLabel: 'Charity no.', accent: null,
              footerText: null, rowId: null,
            },
          },
          text('np19j', 'Receipts, from the same records',
            'A donor needs a receipt to claim the gift against tax, and the wording is what makes it valid — it has to state that nothing was given in return. This is the same block the finance pages use for invoices, saying <b>Receipt</b> instead: the document changes, the data does not. Donor names stay as initials here, exactly as they appear above.'),
